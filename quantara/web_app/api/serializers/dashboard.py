...
class DashboardResponse(BaseModel):
    ...
    health_ratio: str = Field(
        ..., example="2.0", description="The health ratio of the position."
    )
    multipliers: Dict[str, str | None] = Field(
        ...,
        example={"XLM": 1.5},
        description="The multipliers applied to each asset.",
    )
    start_dates: Dict[str, datetime | None] = Field(
        ...,
        example={"XLM": "2024-01-01T00:00:00"},
