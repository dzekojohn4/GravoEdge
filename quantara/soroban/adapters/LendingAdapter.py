"""
GravoEdge Lending Adapter Module
...
The adapter pattern allows GravoEdge to support multiple Stellar-native lending
...
class LendingAdapterFactory:
    ...
    Allows GravoEdge to dynamically select which lending protocol
