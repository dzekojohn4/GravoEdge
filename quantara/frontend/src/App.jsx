...
import GravoEdgeApp from '@/pages/gravoedge-app/GravoEdgeApp';
...
import WithdrawAll from '@/pages/gravoedge/dashboard/withdraw-all/WithdrawAll';
...
function App() {
  ...
  return (
    <div className={`${location.pathname === '/' ? 'home' : isNarrowSidebar ? 'App narrow-sidebar' : 'App'}`}>
      ...
      <main>
        <Routes>
          <Route index element={<GravoEdgeApp onConnectWallet={handleConnectWallet} onLogout={handleLogout} />} />
