      ...
      content: [
        ...
        },
        {
          ...
          items: [
            ...
            'Cross-Chain Compatibility: Quantara supports multiple blockchain ecosystems for a seamless and efficient user experience, providing more liquidity and flexibility across the DeFi ecosystem.',
          ],
        },
      ],
    },
      ...
      content: [
        {
          type: 'text',
          value:
            'Quantara is built on the **Stellar network**, a decentralized, open-source blockchain designed for fast, low-cost, and energy-efficient transactions. Stellar\'s consensus protocol enables near-instant settlement with minimal fees, making it ideal for DeFi applications.',
        },
        {
          type: 'text',
          value:
            'By leveraging Stellar\'s **Soroban smart contracts**, Quantara delivers automated leverage strategies with:',
        },
        {
          type: 'list',
          items: [
        ...
        },
        {
          type: 'text',
          value:
            'The Stellar ecosystem provides the scalability and security needed for professional-grade DeFi, enabling Quantara to offer capital-efficient leverage tools without compromising on safety or user experience.',
        },
      ],
    },
    {
