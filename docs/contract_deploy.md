# Quantara — Legacy Contract Deployment (Archived)

> ⚠️ This document describes deployment of the original **Starknet Cairo contracts**.
> Quantara is migrating to **Soroban contracts** on Stellar. This document is preserved for historical reference.
...
### Declare and deploy quantara Core
In quantara directory(it should compile it and then declare):
