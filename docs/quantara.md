# Quantara — Legacy Smart Contract Documentation (Archived)
...
> Quantara has been fully migrated to **Soroban smart contracts** on the **Stellar network**.
> See [`quantara/soroban/`](../quantara/soroban/) for the current architecture.
