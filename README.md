...
Quantara is being actively migrated to the **Stellar ecosystem**. Current status:
...
Quantara is a **production-grade DeFi protocol** currently in active development for the Stellar ecosystem. The codebase has been professionally rebranded from the original Starknet-based Spotnet protocol with:

- ✅ Complete rebrand (Spotnet → **Quantara**)
